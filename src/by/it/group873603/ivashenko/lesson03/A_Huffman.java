package by.it.group873603.ivashenko.lesson03;
...
while (priorityQueue.size()>1){
    Node childfirst=priorityQueue.poll();

    Node childsecond=priorityQueue.poll();
    Node parent = new InternalNode(childfirst,childsecond);
