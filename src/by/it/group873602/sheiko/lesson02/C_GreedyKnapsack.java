...
public class C_GreedyKnapsack {
    private class Item implements Comparable<Item> {
        ...
        public int compareTo(Item o) {
            ...
            return (this.cost/this.weight - o.cost/o.weight);//сортировка по удельной стоимость каждой вещи
        }
    }
    ...
    double calc(File source) throws FileNotFoundException {
        ...
        int currentNumber = 0; //текущее кол-во вещей в рюкзаке
        ...
        Arrays.sort(items, Collections.reverseOrder());//сортируем в порядке убывания удельного веса
