...
import by.it.group873602.timashkov.lesson02.A_VideoRegistrator;
import by.it.group873602.timashkov.lesson02.B_Sheduler;
import by.it.group873602.timashkov.lesson02.C_GreedyKnapsack;
...
public class Lesson2Test {
    ...
    */
    ...
    public void A_VideoRegistrator() {
        by.it.group873602.timashkov.lesson02.A_VideoRegistrator instance = new A_VideoRegistrator();
    ...
    public void B_Sheduler() {
        ...
        by.it.group873602.timashkov.lesson02.B_Sheduler.Event[] events = {new by.it.group873602.timashkov.lesson02.B_Sheduler.Event(0, 3), new by.it.group873602.timashkov.lesson02.B_Sheduler.Event(0, 1), new by.it.group873602.timashkov.lesson02.B_Sheduler.Event(1, 2), new by.it.group873602.timashkov.lesson02.B_Sheduler.Event(3, 5),
