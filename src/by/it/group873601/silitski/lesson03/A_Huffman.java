package by.it.group873601.silitski.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        PriorityQueue<by.it.group873601.silitski.lesson03.A_Huffman.Node> priorityQueue = new PriorityQueue<>();
        for (Map.Entry<Character, Integer> entry: count.entrySet()) {
            by.it.group873601.silitski.lesson03.A_Huffman.Node node = new by.it.group873601.silitski.lesson03.A_Huffman.LeafNode(entry.getValue(), entry.getKey());
        ...
        while (priorityQueue.size() != 1) {
            by.it.group873601.silitski.lesson03.A_Huffman.Node n1 = priorityQueue.poll();
            by.it.group873601.silitski.lesson03.A_Huffman.Node n2 = priorityQueue.poll();
            by.it.group873601.silitski.lesson03.A_Huffman.Node n;
            if (n1 instanceof by.it.group873601.silitski.lesson03.A_Huffman.LeafNode) {
                n = new by.it.group873601.silitski.lesson03.A_Huffman.InternalNode(n1, n2);
            }
            else {
                n = new by.it.group873601.silitski.lesson03.A_Huffman.InternalNode(n2, n1);
            }
            priorityQueue.add(n);
        }
