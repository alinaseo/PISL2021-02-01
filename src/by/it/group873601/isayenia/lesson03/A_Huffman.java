package by.it.group873601.isayenia.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (int i = 0; i < s.length(); i++){
            char c = s.charAt(i);
            Integer amount = count.get(c);
            count.put(c, amount != null ? amount + 1 : 1);
        }
        ...
        while (priorityQueue.size() != 1) {
            Node num;
            Node num1 = priorityQueue.poll();
            Node num2 = priorityQueue.poll();
            if (num1 instanceof LeafNode){
                num = new InternalNode(num1, num2);
            } else {
                num = new InternalNode(num2, num1);
            }
