package by.it.group873601.kravchenko.lesson08;
...
public class A_Knapsack {
    ...
    //сложность О(n*w), заполнение таблицы снизу вверх, о более простых задач к более сложным
    int getMaxWeight(InputStream stream) {
        ...
        //!!!!!!!!!!!!!!!!!!!!!!!!!     КОНЕЦ ЗАДАЧИ     !!!!!!!!!!!!!!!!!!!!!!!!!
        return dynamicArr[w];//значение последней ячейки таблицы, оптимальная вместимость рюкзака
    }
