package by.it.group873601.tkachenko.lesson05;
...
public class A_QSort {
    ...
    public void sort(Segment[] arr, int first, int last) {
        if (first < last) {
    ...
    private int partition(Segment arr[], int first, int last) {
        Segment pivot = arr[last];
        int i = (first - 1);
